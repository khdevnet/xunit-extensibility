...
namespace CustomTestClassExecution.Custom
{
    ...
    /// </summary>
    public class MyTheoryTestCaseRunner : XunitTestCaseRunner
    {
        ...
        public MyTheoryTestCaseRunner(IXunitTestCase testCase,
                                         string displayName,
                                         string skipReason,
        ...
        protected override async Task AfterTestCaseStartingAsync()
        {
            ...
            try
            {
                ...
                foreach (var dataAttribute in dataAttributes)
                {
                    ...
                    var discovererType = Xunit.Sdk1.SerializationHelper.GetType(args[1], args[0]);
                    ...
                    foreach (var dataRow in data)
                    {
                        ...
                        var test = CreateTest(TestCase, theoryDisplayName+"dddd");
