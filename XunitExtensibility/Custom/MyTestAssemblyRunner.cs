...
{
    public class MyTestAssemblyRunner : TestAssemblyRunner<XunitTestCase>
    {
        ...
        public MyTestAssemblyRunner(ITestAssembly testAssembly,
        ...
        /// <inheritdoc/>
        protected override Task<RunSummary> RunTestCollectionAsync(IMessageBus messageBus, ITestCollection testCollection, IEnumerable<XunitTestCase> testCases, CancellationTokenSource cancellationTokenSource)
            => new MyTestCollectionRunner(testCollection, testCases, DiagnosticMessageSink, messageBus, TestCaseOrderer, new ExceptionAggregator(Aggregator), cancellationTokenSource).RunAsync();
    ...
    //public class MyTestAssemblyRunner : XunitTestAssemblyRunner
    //{
    //    public MyTestAssemblyRunner(ITestAssembly testAssembly,
    //                                  IEnumerable<MyTestCase> testCases,
    //                                  IMessageSink diagnosticMessageSink,
    //                                  IMessageSink executionMessageSink,
    //                                  ITestFrameworkExecutionOptions executionOptions)
    //       : base(testAssembly, testCases, diagnosticMessageSink, executionMessageSink, executionOptions)
    ...
    //       => new MyTestCollectionRunner(testCollection,
    //           testCases,
