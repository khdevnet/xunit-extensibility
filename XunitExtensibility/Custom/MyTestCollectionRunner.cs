...
{
    public class MyTestCollectionRunner : TestCollectionRunner<XunitTestCase>
    {
        /// <summary>
        ...
        public MyTestCollectionRunner(ITestCollection testCollection,
        ...
        /// <inheritdoc/>
        protected override Task<RunSummary> RunTestClassAsync(ITestClass testClass, IReflectionTypeInfo @class, IEnumerable<XunitTestCase> testCases)
            => new MyTestClassRunner(testClass, @class, testCases, DiagnosticMessageSink, MessageBus, TestCaseOrderer, new ExceptionAggregator(Aggregator), CancellationTokenSource, CollectionFixtureMappings).RunAsync();
    }

    //public class MyTestCollectionRunner : XunitTestCollectionRunner
    //{
    //    public MyTestCollectionRunner(ITestCollection testCollection,
    ...
    //    {
    //        var runner = new MyTestClassRunner(
    //             testClass,
    //             @class,
    //             testCases,
